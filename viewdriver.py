...
class ViewDriver:
    ...
    #treeview
        self.tree = ttk.Treeview(self.root, columns=("S.N","Driver Name", "Phone Number", "Email Address", "License No"), show="headings",height=15)
        ...
        self.tree.heading("License No", text="License No")
