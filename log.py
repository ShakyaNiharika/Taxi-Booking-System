...
class TaxiBookingLogin:
    def __init__(self, root):
        ...
        user_label = tk.Label(root, image=self.bg_image)
        user_label.place(relwidth=1, relheight=1)
        
        # gray frame
        gray_frame=tk.Frame(root,bg="#E8E4E4")
        ...
        self.username_entry.place(x=520,y=210)

        c1=tk.Entry(root)
        c1.place(x=520,y=240,height=40, width=340,)
        ...
        self.password_entry.place(x=520,y=300)

        c2=tk.Entry(root)
        c2.place(x=520,y=328,height=40, width=340)
